...
-  [Authentication](#authentication)
    ...
    -  [Authenticating Mirakl](#authenticating-mirakl)
...
### Authenticating Mirakl

In order for Mirakl to install properly, you must add these lines to your auth.json:
    
    "sdk-front-satis.mirakl.net": { 
        "username": "fedex", 
...
Your complete auth.json should look like:
...
NOTE: fx-password NEEDS TO BE REPLACED WITH MOST UP TO DATE PASSWORD FOR MIRAKL.<br/>
Reach out to a senior developer or architect for mirakl sdk password. 
...
https://github.com/FedEx/eai-3537131-fxo-ecommerce-platform/wiki/Troubleshooting
