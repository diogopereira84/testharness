...
{
    public const HERO_BANNER_PRODUCT_TEMPLATE = 'hero-banner-product-template';
    public const SHOP_BY_TYPE = 'shop-by-type';
    public const PRODUCT_PRICING = 'product-pricing';
    public const G7_MASTER_PRINTER_CERTIFICATION = 'g7-master-printer-certification';
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        if (version_compare($context->getVersion(), '1.0.4', '<')) {
            ...
            $this->deleteBlockByIdentifier(self::HERO_BANNER_PRODUCT_TEMPLATE);
            $heroBanner = $this->blockFactory->create();
            $heroBanner->addData($blocks[self::HERO_BANNER_PRODUCT_TEMPLATE])->save();

            $this->deleteBlockByIdentifier(self::SHOP_BY_TYPE);
            $shopByType = $this->blockFactory->create();
            $shopByType->addData($blocks[self::SHOP_BY_TYPE])->save();

            $this->deleteBlockByIdentifier(self::PRODUCT_PRICING);
            $productPricing = $this->blockFactory->create();
            $productPricing->addData($blocks[self::PRODUCT_PRICING])->save();

            $this->deleteBlockByIdentifier(self::G7_MASTER_PRINTER_CERTIFICATION);
            $g7Master = $this->blockFactory->create();
            $g7Master->addData($blocks[self::G7_MASTER_PRINTER_CERTIFICATION])->save();
    ...
    private function getBlocks()
    {
        ...
        $blocks = $this->getHeroBannerBlock($blocks);
        ...
        $blocks = $this->getProductPageTemplateFaqBlock($blocks);
     ...
     * @return array
     */
    public function getHeroBannerBlock($blocks)
    {
        $blocks[self::HERO_BANNER_PRODUCT_TEMPLATE] = [
            "title" => "Hero Banner Product Template",
            "identifier" => "hero-banner-product-template",
            "content" => '<div class="hero-banner product-template-banner" data-content-type="row"
                          data-appearance="full-bleed" data-enable-parallax="0" data-parallax-speed="0.5"
                          ...
                          data-element="main" style="justify-content: flex-start; display: flex; flex-direction: column;
                          background-position: left top; background-size: cover; background-repeat: no-repeat;
                          background-attachment: scroll; border-style: none; border-width: 1px; border-radius: 0px;">
                          <div class="canva-modal-link" data-content-type="banner" data-appearance="collage-left"
                          data-show-button="always" data-show-overlay="always" data-element="main" style="margin: 0px;">
                          <a href="https://www.fedex.com" target="_blank" data-link-type="default" data-element="link">
                        ...
                        {{media url=wysiwyg/PrdTmpltMobBanner.png}}\&quot;,\&quot;desktop_medium_image\&quot;:\&quot;
                        {{media url=wysiwyg/PrdTmpltLapBanner.png}}\&quot;,\&quot;mobile_medium_image\&quot;:\&quot;
                        {{media url=wysiwyg/PrdTmpltTabBanner.png}}\&quot;}"
                        ...
                        style="background-position: left top; background-size: cover; background-repeat: no-repeat;
                        background-attachment: scroll; border-style: none; border-width: 1px; border-radius: 0px;
                        padding: 0px; min-height: 250px;">
                        ...
                        <span id=&quot;XWVOV98&quot; style=&quot;color: #000000;&quot;>You make the</span></h1>
                          ...
                          </h1></div><div class="largetscreenmessage" style="display:none;"><h1>
                          <span style="color: #ffffff;">Create your own yard sign</span>
                          </h1></div>
                          <button type="button" class="pagebuilder-banner-button pagebuilder-button-primary"
    ...
    public function getShopByTypeBlock($blocks)
    {
        $blocks[self::SHOP_BY_TYPE] = [
            ...
            "content" => "<div data-content-type=\"row\" data-appearance=\"contained\" data-element=\"main\">
                          ...
                          padding: 10px;\">
                          <h2 class=\"h2-title\" data-content-type=\"heading\" data-appearance=\"default\"
                          data-element=\"main\" style=\"border-style: none; border-width: 1px;
                          border-radius: 0px;\">Shop by Type</h2>
                          ...
                          display: flex; flex-direction: column; background-position: left top;
                          background-size: cover; background-repeat: no-repeat; background-attachment: scroll;
                          border-style: solid; border-color: rgb(216, 216, 216); border-width: 1px;
                        ...
                        products_count=\"5\" condition_option=\"sku\" condition_option_value=\"1614105200640-4\"
                        type_name=\"Catalog Products List\" product_image_id=\"shop_by_type_grid\"
                        ...
                        <li>Environmental factors are not a concern</li>
                        </ul></div>
                        ...
                        type_name='Catalog Product Link' }}\" target=\"\" data-link-type=\"product\"
                        ...
                        data-same-width=\"false\" data-element=\"main\"
                        style=\"border-style: none; border-width: 1px; border-radius: 0px;
                        margin: 0px; padding: 0px;\"><div class=\"fedex-bold\" data-content-type=\"button-item\"
                        data-appearance=\"default\" data-element=\"main\" style=\"display: inline-block;\">
                        <a class=\"pagebuilder-button-link\"
                        href=\"{{widget type='Magento\Catalog\Block\Product\Widget\Link'
                        ...
                        border-color: rgb(216, 216, 216); border-width: 1px; border-radius: 0px; width: 33.3333%;
                        align-self: stretch;\">
                        <div data-content-type=\"products\"
                        data-appearance=\"simple-product-grid\" data-element=\"main\"
                        ...
                        border-radius: 0px; margin: 0px; padding: 0px;\">
                        {{widget type=\"Magento\CatalogWidget\Block\Product\ProductsList\"
                        template=\"Fedex_PageBuilderExtensionProducts::
                        product/widget/content/simple-product-grid.phtml\"
                        ...
                        `value`:`1`^],`1--1`:^[`operator`:`()`,`type`:
                        `Magento||CatalogWidget||Model||Rule||Condition||Product`,
                        `attribute`:`sku`,`value`:`1614105200640-4`^]^]\" sort_order=\"position_by_sku\"}}</div>
                        <div class=\"bullets\" data-content-type=\"text\" data-appearance=\"default\"
                        data-element=\"main\" style=\"border-style: none; border-width: 1px;
                        border-radius: 0px; margin: 0px; padding: 0px;\"><ul>
                        <li>Corrugated plastic sign with wire H-stake display</li>
                        <li>Environmental factors are not a concern</li>
                        </ul></div><div data-content-type=\"buttons\" data-appearance=\"inline\"
                        data-same-width=\"false\" data-element=\"main\" style=\"border-style: none;
                        border-width: 1px; border-radius: 0px; margin: 0px; padding-bottom: 0px;\">
                        <div class=\"fedex-bold\" data-content-type=\"button-item\" data-appearance=\"default\"
                        data-element=\"main\" style=\"display: inline-block;\">
                        <a class=\"pagebuilder-button-link\"
                        href=\"{{widget type='Magento\Catalog\Block\Product\Widget\Link'
                        id_path='product/578' template='Magento_PageBuilder::widget/link_href.phtml'
                        type_name='Catalog Product Link' }}\" target=\"\" data-link-type=\"product\"
                        ...
                        template=\"Fedex_PageBuilderExtensionProducts::
                        product/widget/content/simple-product-grid.phtml\"
                        anchor_text=\"\" id_path=\"\" show_pager=\"0\" products_count=\"5\" condition_option=\"sku\"
                        condition_option_value=\"1594830761054-4\" type_name=\"Catalog Products List\"
                        product_image_id=\"shop_by_type_grid\" conditions_encoded=\"^[`1`:^[`aggregator`:`all`,
                        `new_child`:``,`type`:`Magento||CatalogWidget||Model||Rule||Condition||Combine`,
                        `value`:`1`^],`1--1`:^[`operator`:`()`,`type`:
                        `Magento||CatalogWidget||Model||Rule||Condition||Product`,
                        `attribute`:`sku`,`value`:`1594830761054-4`^]^]\" sort_order=\"position_by_sku\"}}
                        </div>
                        <div class=\"bullets\" data-content-type=\"text\" data-appearance=\"default\"
                        data-element=\"main\" style=\"border-style: none; border-width: 1px;
                        border-radius: 0px; margin: 0px; padding: 0px;\"><ul>
    ...
    {
        $blocks[self::PRODUCT_PRICING] = [
            "title" => "Product Pricing",
            "identifier" => "product-pricing",
            "content"   => '<div data-content-type="row" data-appearance="contained" data-element="main">
                            <div class="product-pricing-section-block hide" data-enable-parallax="0"
                            ...
                            <h2 class="h2-title" data-content-type="heading" data-appearance="default"
                            data-element="main" style="border-style: none; border-width: 1px;
                            border-radius: 0px;">Product Pricing Section</h2>
                            <div class="tab-align-left" data-content-type="tabs" data-appearance="default"
                            data-active-tab="" data-element="main" style="margin: 0px; padding: 0px;">
                            ...
                            <a href="#CHGJL8U" class="tab-title"><span class="tab-title">Custom Boxes</span>
                            </a></li>
                            <li role="tab" class="tab-header" data-element="headers" style="border-radius: 0px;
                            border-width: 1px;">
                            <a href="#KEE6L6Y" class="tab-title"><span class="tab-title">Indoor Banners</span></a></li>
                            <li role="tab" class="tab-header" data-element="headers"
                            style="border-radius: 0px; border-width: 1px;">
                            <a href="#JX9GY0G" class="tab-title"><span class="tab-title">Styrene Signs</span></a></li>
                            <li role="tab" class="tab-header" data-element="headers" style="border-radius: 0px;
                            border-width: 1px;">
                            <a href="#O1CFHX9" class="tab-title"><span class="tab-title">Announcements</span></a></li>
                            <li role="tab" class="tab-header" data-element="headers"
                            style="border-radius: 0px; border-width: 1px;">
                            <a href="#O61P56X" class="tab-title"><span class="tab-title">Mounted Posters</span></a></li>
                            <li role="tab" class="tab-header" data-element="headers"
                            style="border-radius: 0px; border-width: 1px;">
                            <a href="#Y8F22BE" class="tab-title"><span class="tab-title">Presentations</span></a></li>
                            <li role="tab" class="tab-header" data-element="headers"
                            style="border-radius: 0px; border-width: 1px;">
                            <a href="#SALUNFE" class="tab-title"><span class="tab-title">Rubber Stamps</span></a></li>
                            </ul>
                            ...
                            data-tab-name="Custom Boxes" data-background-images="{}" data-element="main"
                            id="CHGJL8U" style="justify-content: flex-start; display: flex; flex-direction: column;
                            background-position: left top; background-size: cover; background-repeat: no-repeat;
                            background-attachment: scroll; border-width: 1px; border-radius: 0px; margin: 0px;
                            padding: 40px;">
                            ...
                            <div class="pagebuilder-banner-wrapper"
                            data-background-images="{\&quot;desktop_image\&quot;:\&quot;
                            {{media url=wysiwyg/cq5dam-dsk-300x400.jpeg}}\&quot;,
                            \&quot;mobile_image\&quot;:\&quot;
                            {{media url=wysiwyg/cq5dam-mob-120x160.jpeg}}\&quot;,
                            \&quot;desktop_medium_image\&quot;:\&quot;
                            {{media url=wysiwyg/cq5dam-dsk-300x400_1.jpeg}}\&quot;,
                            \&quot;mobile_medium_image\&quot;:\&quot;
                            {{media url=wysiwyg/cq5dam-tablet-150x200.jpeg}}\&quot;}" data-background-type="image"
                            data-video-loop="true" data-video-play-only-visible="true" data-video-lazy-load="true"
                            data-video-fallback-src="" data-element="wrapper" style="background-position: right top;
                            ...
                            data-element="overlay" style="border-radius: 0px;
                            ...
                            <div class="largetscreenmessage" style="display:none;"></div>
                            </div></div></div></div></div></div>
                            <div class="pagebuilder-column right-column-html"
                            data-content-type="column" data-appearance="full-height" data-background-images="{}"
                            data-element="main" style="justify-content: flex-start; display: flex;
                            flex-direction: column; background-position: left top; background-size: cover;
                        ...
                        div class="shopnow-product-pricing-container"&gt;
                            &lt;div class="show-innerbox d-inline-block fedex-bold ls-1 fs-14 lh-19"&gt;
                                ...
                                a href="#" class="show-toggle-link"&gt;SHOW MORE OPTIONS&lt;/a&gt;&lt;/span&gt;
                            &lt;/div&gt;
                        ...
                        id="KEE6L6Y" style="justify-content: flex-start; display: flex; flex-direction: column;
                        background-position: left top; background-size: cover; background-repeat: no-repeat;
                        ...
                        border-radius: 0px; margin: 0px; padding: 0px;">
                        &lt;div class="shopnow-product-pricing-container"&gt;
                            &lt;div class="show-innerbox d-inline-block
                            fedex-bold ls-1 fs-14 lh-19"&gt;
                        ...
                        <div class="btn-shopnow hide" data-content-type="button-item"
                        data-appearance="default" data-element="main" style="display: inline-block;">
                        <a class="pagebuilder-button-secondary" href="https://staging3.office.fedex.com/default/"
                        target="" data-link-type="default" data-element="link" style="text-align: center;">
                        <span data-element="link_text">SHOP NOW</span></a></div></div></div></div></div>
                        <div data-content-type="tab-item" data-appearance="default"
                        data-tab-name="Styrene Signs" data-background-images="{}" data-element="main"
                        id="JX9GY0G" style="justify-content: flex-start; display: flex; flex-direction: column;
                        background-position: left top; background-size: cover; background-repeat: no-repeat;
                        background-attachment: scroll; border-width: 1px; border-radius: 0px; margin: 0px;
                        padding: 40px;">
                        <div class="pagebuilder-column-group" style="display: flex;"
                        ...
                        <div class="pagebuilder-banner-wrapper"
                        data-background-images="{\&quot;desktop_image\&quot;:\&quot;
                        {{media url=wysiwyg/dsadam-dsk-300x400.jpeg}}\&quot;,
                        \&quot;mobile_image\&quot;:\&quot;
                        {{media url=wysiwyg/dsadam-mob-120x160.jpeg}}\&quot;,
                        \&quot;desktop_medium_image\&quot;:\&quot;
                        ...
                        data-element="wrapper" style="background-position: right top; background-size: contain;
                        background-repeat: no-repeat; background-attachment: scroll; border-style: none;
                        ...
                        <div class="pagebuilder-poster-content">
                        <div class="message" messagelaptop="" messagetablet=""
                        messagemobile="" data-element="content"><p>
                        </p><p></p></div>
                        ...
                        <div data-content-type="tab-item" data-appearance="default"
                        data-tab-name="Announcements" data-background-images="{}"
                        data-element="main" id="O1CFHX9" style="justify-content: flex-start;
                        display: flex; flex-direction: column; background-position: left top;
                        background-size: cover; background-repeat: no-repeat;
                        background-attachment: scroll; border-width: 1px;
                        ...
                        <div class="pagebuilder-banner-wrapper"
                        data-background-images="{\&quot;desktop_image\&quot;:
                        \&quot;{{media url=wysiwyg/dsadam-dsk-300x400_2.jpeg}}\&quot;,
                        \&quot;mobile_image\&quot;:\&quot;
                        {{media url=wysiwyg/dsadam-mob-120x160_1.jpeg}}\&quot;,
                        \&quot;desktop_medium_image\&quot;:\&quot;
                        {{media url=wysiwyg/dsadam-dsk-300x400_3.jpeg}}\&quot;,
                        \&quot;mobile_medium_image\&quot;:\&quot;
                        ...
                        border-style: none; border-width: 1px; border-radius: 0px;">
                        <div class="pagebuilder-overlay pagebuilder-poster-overlay"
                        data-overlay-color="" data-element="overlay"
                        style="border-radius: 0px; min-height: 400px;
                        background-color: transparent; padding: 40px;">
                        <div class="pagebuilder-poster-content">
                        <div class="message" messagelaptop="" messagetablet=""
                        messagemobile="" data-element="content"></div>
                        <div class="largetscreenmessage" style="display:none;">
                        ...
                        div class="promo-content third-party product-pricing"&gt;
                            &lt;div class="pagebuilder-column-group"&gt;
                                &lt;div class="pagebuilder-column promo-content-row m-auto" style="max-width: 500px"&gt;
                                        &lt;div class="promo-content-block
                                        product-pricing-innerbox"&gt;
                                            &lt;div class="promo-content-row table-head fedex-bold
                                            fedex-medium fs-20 lh-24" style="color: #2F4047"&gt;
                                                &lt;span class="text-left"&gt;Sizes&lt;/span&gt;
                                                &lt;span class="text-left"&gt;# of Sides&lt;/span&gt;
                                                &lt;span class="text-left"&gt;Starting Cost&lt;/span&gt;
                                            &lt;/div&gt;
                            ...
                            &lt;/div&gt;
                        &lt;/div&gt;
                        </div><div data-content-type="html"
                        data-appearance="default" data-element="main"
                        ...
                        border-style: none; border-width: 1px; border-radius: 0px;
                        width: 50%; margin: 0px; padding: 10px; align-self: stretch;">
                        </div><div class="pagebuilder-column right-column-html"
                        data-content-type="column" data-appearance="full-height"
                        data-background-images="{}" data-element="main"
                        style="justify-content: flex-start; display: flex;
                        flex-direction: column; background-position: left top;
                        ...
                        &lt;div class="shopnow-product-pricing-container"&gt;
                            ...
                            &lt;/div&gt;
                        &lt;/div&gt;
                        </div><div data-content-type="buttons"
                        data-appearance="inline" data-same-width="false"
                        data-element="main" style="border-style: none;
                        border-width: 1px; border-radius: 0px; margin: 0px; padding: 0px;">
                        <div class="btn-shopnow hide" data-content-type="button-item"
                        ...
                        <div class="pagebuilder-banner-wrapper"
                        data-background-images="{\&quot;desktop_image\&quot;:\&quot;
                        {{media url=wysiwyg/dsadam-dsk-300x400_4.jpeg}}\&quot;,
                        \&quot;mobile_image\&quot;:\&quot;{{media url=wysiwyg/dsadam-mob-120x160_2.jpeg}}\&quot;,
                        \&quot;desktop_medium_image\&quot;:\&quot;
                        {{media url=wysiwyg/dsadam-dsk-300x400_5.jpeg}}\&quot;,
                        \&quot;mobile_medium_image\&quot;:\&quot;
                        ...
                        background-size: cover; background-repeat: no-repeat;
                        background-attachment: scroll; border-style: none;
                        border-width: 1px; border-radius: 0px; width: 50%; margin: 0px;
                        padding: 10px; align-self: stretch;">
                        <div data-content-type="html" data-appearance="default"
                        data-element="main" style="border-style: none; border-width: 1px;\
                        border-radius: 0px; margin: 0px; padding: 0px;">
                        ...
                        <span data-element="link_text">SHOP NOW</span></a></div></div></div></div></div>
                        <div data-content-type="tab-item" data-appearance="default"
                        data-tab-name="Rubber Stamps" data-background-images="{}" data-element="main"
                        id="SALUNFE" style="justify-content: flex-start; display: flex;
                        flex-direction: column; background-position: left top; background-size: cover;
                        ...
                        data-appearance="full-height" data-background-images="{}"
                        data-element="main" style="justify-content: flex-start; display: flex;
                        flex-direction: column; background-position: center center; background-size: cover;
                        background-repeat: no-repeat; background-attachment: scroll; text-align: center;
                        border-style: none; border-width: 1px; border-radius: 0px; width: 50%;
                        margin: 0px; padding: 10px; align-self: stretch;">
                        <div data-content-type="banner" data-appearance="poster" data-show-button="never"
                        ...
                        <div class="pagebuilder-banner-wrapper"
                        data-background-images="{\&quot;desktop_image\&quot;:\&quot;
                            {{media url=wysiwyg/dsadam-dsk-300x400_6.jpeg}}\&quot;,
                            \&quot;mobile_image\&quot;:\&quot;
                            {{media url=wysiwyg/dsadam-mob-120x160_3.jpeg}}\&quot;,
                            \&quot;desktop_medium_image\&quot;:\&quot;
                            {{media url=wysiwyg/dsadam-dsk-300x400_7.jpeg}}\&quot;,
                            \&quot;mobile_medium_image\&quot;:\&quot;
                            ...
                            <div class="pagebuilder-overlay pagebuilder-poster-overlay"
                            data-overlay-color="" data-element="overlay"
                            style="border-radius: 0px; min-height: 400px; background-color: transparent;
                            padding: 40px;">
                            <div class="pagebuilder-poster-content">
                            <div class="message" messagelaptop="" messagetablet=""
                            messagemobile="" data-element="content"></div>
                        ...
                        href="https://staging3.office.fedex.com/default/products-template-t6#RSBDDK3"
                        target="" data-link-type="default" data-element="link" style="text-align: center;">
                        <span data-element="link_text">SHOP NOW</span></a></div></div>
                        </div></div></div></div></div></div></div>
                        <div data-content-type="row" data-appearance="contained"
                        data-element="main"><div data-enable-parallax="0" data-parallax-speed="0.5"
    ...
    {
        $blocks[self::G7_MASTER_PRINTER_CERTIFICATION] = [
            ...
            "content" => '<div data-content-type="row" data-appearance="contained" data-element="main">
                        ...
                        background-size: cover; background-repeat: no-repeat;
                        background-attachment: scroll; border-style: none; border-width: 1px;
                        border-radius: 0px; width: 16.6667%; margin: 0px; padding: 10px; align-self: stretch;">
                        ...
                        <a href="https://connect.idealliance.org/g7/home" target=""
                        data-link-type="default" title="" data-element="link">
                        <img class="pagebuilder-mobile-hidden"
                        src="{{media url=wysiwyg/Hnet.com-image_2_.png}}"
                        alt="" title="" data-element="desktop_image" style="border-style: none;
                        border-width: 1px; border-radius: 0px; max-width: 100%; height: auto;">
                        ...
                        <div class="pagebuilder-column" data-content-type="column"
                        data-appearance="align-center" data-background-images="{}"
                        data-element="main" style="justify-content: flex-start; display: flex;
                        flex-direction: column; background-position: left top;
                        background-size: cover; background-repeat: no-repeat;
                        background-attachment: scroll; border-style: none; border-width: 1px;
                        border-radius: 0px; width: 83.3333%; margin: 0px; padding: 10px; align-self: center;">
                        <div class="fedex-light fs-16" data-content-type="text" data-appearance="default"
                        data-element="main" style="border-style: none; border-width: 1px;
                        border-radius: 0px; margin: 0px; padding: 0px;"><p>
                        <span style="color: #2f4047;">G7 Master Qualified Printer</span></p>
                        <p><span style="color: #2f4047;">
    ...
    /**
     * GetProductTemplateFaq Block
     *
     * @return array
     */
    public function getProductPageTemplateFaqBlock($blocks)
    {
        $blocks[self::PRODUCT_PAGE_TEMPLATE_FAQ] = [
            ...
            "content" => '<div data-content-type="row" data-appearance="contained" data-element="main">
                        ...
                        &lt;li&gt;Get started on&amp;nbsp;FedEx Office&lt;sup&gt;
                        ®&lt;/sup&gt;&amp;nbsp;Print Online&lt;/li&gt;
                        &lt;li&gt;See&amp;nbsp;&lt;
                        ...
                        &lt;/div&gt;
                            ...
                            &lt;div class="collapsible" data-role="collapsible"&gt;
                                &lt;div class="d-flex v-center pointer" data-role="trigger"&gt;
                                    &lt;span class="label"&gt;Where can
                                    I learn how to make a business sign?&lt;/span&gt;
                                    &lt;span class="icons" data-role="icons"&gt;&lt;/span&gt;
                                &lt;/div&gt;
                        ...
                        &lt;li&gt;Sign packages include your printed
                        sign plus a display stand at a discounted price.&lt;/li&gt;
                        &lt;/ul&gt;
                        &lt;/div&gt;
                            &lt;/div&gt;
                              &lt;div class="collapsible" data-role="collapsible"&gt;
                                &lt;div class="d-flex v-center pointer" data-role="trigger"&gt;
                                    ...
                                    &lt;span class="icons" data-role="icons"&gt;&lt;/span&gt;
                                &lt;/div&gt;
                                &lt;div data-role="content"&gt;  Corrugated plastic yard signs
                                are easy to order using FedEx Office® Print Online.
                                Choose a standard size or create a custom size. Perfect for
                                outdoor and short-term use, yard signs can be used for directional signage and
                                may be 1 or 2-sided. Select a yard sign frame and hardware. No need to know
                                how to make your own sign; FedEx Office is here to help.
                         &lt;/div&gt;
                            &lt;/div&gt;
                                &lt;div class="collapsible" data-role="collapsible"&gt;
                                &lt;div class="d-flex v-center pointer" data-role="trigger"&gt;
    ...
    /**
     * DeleteBlockByIdentifier method
     *
    ...
    /**
     * GetProductTemplate Page method
     *
    ...
    private function getProductTemplatePage(
        ...
        return [
            ...
            "content"       => "<div data-content-type=\"row\" data-appearance=\"contained\" data-element=\"main\">
                                ...
                                block_id=\"{$heroBanner}\" type_name=\"CMS Static Block\"}}</div>
                                <div data-content-type=\"block\" data-appearance=\"default\" data-element=\"main\"
                                style=\"border-style: none; border-width: 1px; border-radius: 0px;
                                margin: 0px; padding: 0px;\">
                                {{widget type=\"Magento\Cms\Block\Widget\Block\"
            ...
            "canva_size"    => '[{"record_id":"0","default":"0","product_mapping_id":"CVAPOS1068",
                               ...
                               "position":"1","initialize":"true"},{"record_id":"1",
                                "default":"1","product_mapping_id":"CVAPOS1069","display_width":"28\"",
                                "display_height":"22\"","orientation":"Landscape","position":"2","initialize":"true"}]',
            "is_active"     => 1,
            "has_canva_sizes"=> 0,
            "stores" => [0]
        ];
    ...
    /**
     * DeleteOldProductTemplate method
     */
    ...
    /**
     * GetProductTemplatePageBuilderTemplate method
     *
     * @param int $heroBanner
     * @param int $shopByType
     * @param int $productPricing
    ...
    private function getProductTemplatePageBuilderTemplate(
        ...
        return[
            ...
            "template"      => "<div data-content-type=\"row\" data-appearance=\"contained\"
                                data-element=\"main\"><div data-enable-parallax=\"0\" data-parallax-speed=\"0.5\"
                                data-background-images=\"{}\" data-background-type=\"image\" data-video-loop=\"true\"
                                data-video-play-only-visible=\"true\" data-video-lazy-load=\"true\"
                                ...
                                margin: 0px; padding: 0px;\">{{widget type=\"Magento\Cms\Block\Widget\Block\"
                                template=\"widget/static_block/default.phtml\"
                                block_id=\"{$shopByType}\" type_name=\"CMS Static Block\"}}</div>
                                <div data-content-type=\"block\" data-appearance=\"default\"
                                data-element=\"main\" style=\"border-style: none; border-width: 1px;
                                border-radius: 0px; margin: 0px; padding: 0px;\">
                                {{widget type=\"Magento\Cms\Block\Widget\Block\"
