...
use Fedex\PageBuilderBlocks\Setup\UpgradeData;
...
class UpgradeDataTest extends TestCase
{
    ...
    public function testInstall()
    {
        ...
        $this->contextInterface->expects($this->any())->method('getVersion')->willReturn('1.0.2');
        ...
        $this->assertSame(null, $this->upgradeData->upgrade($this->dataInterface, $this->contextInterface));
    }
}
