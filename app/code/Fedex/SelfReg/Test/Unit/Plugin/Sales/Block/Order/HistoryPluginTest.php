...
namespace Fedex\SelfReg\Test\Unit\Plugin\Sales\Block\Order;

use Magento\Authorization\Model\UserContextInterface;
use Magento\Framework\App\RequestInterface;
use Magento\Framework\TestFramework\Unit\Helper\ObjectManager;
use Magento\NegotiableQuote\Block\Order\OwnerFilter;
use Fedex\SelfReg\Plugin\Sales\Block\Order\HistoryPlugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->historyPlugin = $objectManager->getObject(
            ...
            [
                ...
                'permissionHelper' => $this->permissionHelperMock
            ]
        );
    }
