...
use Fedex\SSO\Controller\Index\CustomLoginMobile;
 ...
 */
class CustomLoginMobileTest extends TestCase
{

    protected $customerLoginMobile;
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->customerLoginMobile = $this->objectManager->getObject(
            CustomLoginMobile::class,
            [
    ...
    public function testExecuteWithoutLogin()
    {
        ...
        $this->assertSame(null, $this->customerLoginMobile->execute());
    }
