...
namespace Fedex\CIDPSG\Test\Unit\Model\ResourceModel\PsgCustomerFields;
...
use Fedex\CIDPSG\Model\ResourceModel\PsgCustomerFields\Collection;
...
/**
 * test class for collection test PSG customer fields
 */
class CollectionTest extends TestCase
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertEquals(PsgCustomerFieldsModel::class, $this->model->getModelName());
        $this->assertEquals(PsgCustomerFieldsResourceModel::class, $this->model->getResourceModelName());
    }
}
