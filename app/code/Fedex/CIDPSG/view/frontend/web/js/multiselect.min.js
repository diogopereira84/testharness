if (!m_helper) {
	var m_helper = {
        ...
        setActiveOnClick: function(element) {
            if (!jQuery("#state_of_exemption_itemList").hasClass("active")) {
			    element.classList.add('active');
            } else {
...
Multiselect.prototype = {
	...
	_createItemList: function() {
		...
		var selectAll = this._createItem('span', -1, 'Select all states');
    ...
    _showListOnClick: function(context) {
		m_helper.setActiveOnClick(document.getElementById(context._getItemListIdentifier()))
	},
