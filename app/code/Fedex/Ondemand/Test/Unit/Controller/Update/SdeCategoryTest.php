...
use Fedex\Ondemand\Controller\Update\SdeCategory;
...
class SdeCategoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->categoryMock  = $this->getMockBuilder(Category::class)
            ->setMethods(['load', 'setId', 'getName', 'getUrlKey','setName', 'setUrlKey', 'save'])
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->sdeCategoryMock = $this->objectManagerHelper->getObject(
            SdeCategory::class,
            [
    ...
    public function testExecute()
    {
        ...
        $this->assertNull($this->sdeCategoryMock->execute());
    }
