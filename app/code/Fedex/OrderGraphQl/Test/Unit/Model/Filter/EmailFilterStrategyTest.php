...
use Fedex\OrderGraphQl\Model\Filter\EmailFilterStrategy;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;
use Magento\Framework\Api\SearchCriteriaBuilder;

class EmailFilterStrategyTest extends TestCase
{
    /** @var MockObject|SearchCriteriaBuilder */
    private SearchCriteriaBuilder|MockObject $searchCriteriaBuilder;

    /** @var EmailFilterStrategy  */
    private EmailFilterStrategy $object;
    ...
    public function setUp(): void
    {
        ...
        $this->object = new EmailFilterStrategy();
    }
