...
use Fedex\OrderGraphQl\Model\Filter\ShippingDueDateFilterStrategy;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;
use Magento\Framework\Api\SearchCriteriaBuilder;

class ShippingDueDateFilterStrategyTest extends TestCase
{
    /** @var MockObject|SearchCriteriaBuilder */
    private SearchCriteriaBuilder|MockObject $searchCriteriaBuilder;

    /** @var ShippingDueDateFilterStrategy  */
    private ShippingDueDateFilterStrategy $object;
    ...
    public function setUp(): void
    {
        ...
        $this->object = new ShippingDueDateFilterStrategy();
    }
