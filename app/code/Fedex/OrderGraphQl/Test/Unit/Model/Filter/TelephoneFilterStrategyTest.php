...
use Fedex\OrderGraphQl\Model\Filter\TelephoneFilterStrategy;
use Magento\Framework\GraphQl\Exception\GraphQlInputException;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;
use Magento\Framework\Api\SearchCriteriaBuilder;

class TelephoneFilterStrategyTest extends TestCase
{
    /** @var MockObject|SearchCriteriaBuilder */
    private SearchCriteriaBuilder|MockObject $searchCriteriaBuilder;

    /** @var TelephoneFilterStrategy  */
    private TelephoneFilterStrategy $object;

    public function setUp(): void
    {
        $this->searchCriteriaBuilder = $this->createMock(SearchCriteriaBuilder::class);
        $this->object = new TelephoneFilterStrategy();
    }
    ...
    public function testApplyFilter(){
        $this->searchCriteriaBuilder->expects($this->exactly(1))
            ->method('addFilter')
