...
namespace Fedex\CustomerExportEmail\Test\Unit\Model\Component\MassAction;
...
class FilterTest extends TestCase
{
    ...
    public function testGetCollection($selectedIds, $excludedIds, $filterExpected, $conditionExpected): void
    {
        ...
        $this->requestMock
            ...
            ->willReturnOnConsecutiveCalls('true', $selectedIds, $excludedIds, $selectedIds, $excludedIds, '');
