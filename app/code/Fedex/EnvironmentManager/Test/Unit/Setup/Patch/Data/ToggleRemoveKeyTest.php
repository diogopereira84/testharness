...
use Fedex\EnvironmentManager\Setup\Patch\Data\ToggleRemoveKey;

class ToggleRemoveKeyTest extends TestCase
{
    /**
     * @var ToggleRemoveKey
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new ToggleRemoveKey($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(ToggleRemoveKey::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
