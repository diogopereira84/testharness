...
use Fedex\EnvironmentManager\Setup\Patch\Data\SharedCatalogToogleRemove;

class RemoveFedexAccountAppearToggleXmenTest extends TestCase
{
    /**
     * @var ToggleRemoveKey
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new SharedCatalogToogleRemove($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(SharedCatalogToogleRemove::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
