...
use Fedex\EnvironmentManager\Setup\Patch\Data\RemoveToggleFolderPermission;

class RemoveToggleFolderPermissionTest extends TestCase
{
    /**
     * @var RemoveToggleFolderPermission
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveToggleFolderPermission($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveToggleFolderPermission::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
