...
use Fedex\EnvironmentManager\Setup\Patch\Data\RemoveArmadaToggleKeys;

class RemoveArmadaToggleKeysTest extends TestCase
{
    /**
     * @var RemoveArmadaToggleKeys
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveArmadaToggleKeys($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveArmadaToggleKeys::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
