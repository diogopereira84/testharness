...
use Fedex\EnvironmentManager\Setup\Patch\Data\RemoveMazegeeksToggleKeys;

class RemoveMazegeeksToggleKeysTest extends TestCase
{
    /**
     * @var RemoveMazegeeksToggleKeys
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveMazegeeksToggleKeys($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveMazegeeksToggleKeys::CORE_CONFIG_DATA_KEY)+1))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
