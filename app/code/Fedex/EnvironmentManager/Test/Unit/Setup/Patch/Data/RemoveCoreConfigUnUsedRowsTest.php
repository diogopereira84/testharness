...
use Fedex\EnvironmentManager\Setup\Patch\Data\RemoveCoreConfigUnUsedRows;

class RemoveCoreConfigUnUsedRowsTest extends TestCase
{
    /**
     * @var RemoveCoreConfigUnUsedRows
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveCoreConfigUnUsedRows($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveCoreConfigUnUsedRows::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
