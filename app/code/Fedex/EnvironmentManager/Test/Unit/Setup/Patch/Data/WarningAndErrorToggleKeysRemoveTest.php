...
use Fedex\EnvironmentManager\Setup\Patch\Data\WarningAndErrorToggleKeysRemove;

class WarningAndErrorToggleKeysRemoveTest extends TestCase
{
    /**
     * @var WarningAndErrorToggleKeysRemove
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new WarningAndErrorToggleKeysRemove($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(WarningAndErrorToggleKeysRemove::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
