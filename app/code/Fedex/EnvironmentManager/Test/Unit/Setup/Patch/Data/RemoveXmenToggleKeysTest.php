...
namespace Fedex\EnvironmentManager\Test\Unit\Setup\Patch\Data\RemoveXmenToggleKeysTest;

use PHPUnit\Framework\TestCase;
use Magento\Framework\Setup\Patch\DataPatchInterface;
use Magento\Framework\Setup\SchemaSetupInterface;
use Fedex\EnvironmentManager\Setup\Patch\Data\RemoveXmenToggleKeys;

class RemoveXmenToggleKeysTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveXmenToggleKeys($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveXmenToggleKeys::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
