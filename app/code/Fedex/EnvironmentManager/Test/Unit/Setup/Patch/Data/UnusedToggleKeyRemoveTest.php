...
use Fedex\EnvironmentManager\Setup\Patch\Data\ToggleKeysRemove;

class UnusedToggleKeyRemoveTest extends TestCase
{
    /**
     * @var ToggleKeysRemove
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new ToggleKeysRemove($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(ToggleKeysRemove::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
