...
use Fedex\EnvironmentManager\Setup\Patch\Data\RemoveLegacyToggle;

class RemoveLegacyToggleTest extends TestCase
{
    /**
     * @var RemoveLegacyToggle
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveLegacyToggle($this->setup);
    }
    ...
    /**
     * Test function testGetDependencies
     *
     */
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveLegacyToggle::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
