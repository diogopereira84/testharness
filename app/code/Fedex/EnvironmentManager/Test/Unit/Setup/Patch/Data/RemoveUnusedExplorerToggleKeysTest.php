...
use Fedex\EnvironmentManager\Setup\Patch\Data\RemoveUnusedExplorerToggleKeys;

class RemoveUnusedExplorerToggleKeysTest extends TestCase
{
    /**
     * @var RemoveUnusedExplorerToggleKeys
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveUnusedExplorerToggleKeys($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveUnusedExplorerToggleKeys::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
