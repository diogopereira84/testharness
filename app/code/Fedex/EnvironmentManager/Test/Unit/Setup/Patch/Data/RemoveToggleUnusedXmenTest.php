...
namespace Fedex\EnvironmentManager\Test\Unit\Setup\Patch\Data\RemoveToggleUnusedXmenTest;

use PHPUnit\Framework\TestCase;
use Magento\Framework\Setup\Patch\DataPatchInterface;
use Magento\Framework\Setup\SchemaSetupInterface;
use Fedex\EnvironmentManager\Setup\Patch\Data\RemoveToggleUnusedXmen;

class RemoveToggleUnusedXmenTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveToggleUnusedXmen($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveToggleUnusedXmen::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
