...
use Fedex\EnvironmentManager\Setup\Patch\Data\ToggleRemoveArmada;

class ToggleRemoveArmadaTest extends TestCase
{
    /**
     * @var ToggleRemoveArmada
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new ToggleRemoveArmada($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(ToggleRemoveArmada::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
