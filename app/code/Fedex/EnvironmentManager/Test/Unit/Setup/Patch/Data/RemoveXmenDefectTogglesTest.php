...
use Fedex\EnvironmentManager\Setup\Patch\Data\RemoveXmenDefectToggles;
use PHPUnit\Framework\MockObject\MockObject;
use Magento\Framework\DB\Adapter\AdapterInterface;

class RemoveXmenDefectTogglesTest extends TestCase
{
    /**
     * @var ToggleRemoveKey
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveXmenDefectToggles($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveXmenDefectToggles::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
