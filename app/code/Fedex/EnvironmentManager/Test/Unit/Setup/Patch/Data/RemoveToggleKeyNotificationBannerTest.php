...
use Fedex\EnvironmentManager\Setup\Patch\Data\RemoveToggleKeyNotificationBanner;

class RemoveToggleKeyNotificationBannerTest extends TestCase
{
    /**
     * @var RemoveToggleKeyNotificationBanner
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveToggleKeyNotificationBanner($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveToggleKeyNotificationBanner::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
