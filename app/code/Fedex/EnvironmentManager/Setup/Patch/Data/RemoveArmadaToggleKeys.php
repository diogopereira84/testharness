...
class RemoveArmadaToggleKeys implements DataPatchInterface
{
    // core config data table unused key
    const CORE_CONFIG_DATA_KEY = [
        'armada_mobile_minicart_fix',
        'armada_admin_approve_sde',
        'armada_delete_order_test',
        'armada_order_history_total_fix'
    ];
