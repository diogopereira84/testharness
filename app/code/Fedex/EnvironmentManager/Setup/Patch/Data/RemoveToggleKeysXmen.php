...
class RemoveToggleKeysXmen implements DataPatchInterface
{
    // core config data table unused key
    public const CORE_CONFIG_DATA_KEY = [
        'explorers_delivery_price_fix',
        'xmen_edit_pickup_review',
        'xmen_sde_order_view_discount_fix',
        'xmen_email_control_character_remove'
    ];
