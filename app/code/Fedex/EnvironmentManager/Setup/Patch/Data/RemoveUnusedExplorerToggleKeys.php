...
class RemoveUnusedExplorerToggleKeys implements DataPatchInterface
{
    // core config data table unused key
    const CORE_CONFIG_DATA_KEY = [
        'explorers_display_comp_shared_orders',
        'explorers_D170021_fix',
        'explorers_D169578_fix',
        'explorers_d_169768_fix',
        'order_confirmation_custom_messaging'
    ];
