...
class RemoveToggleKeyNotificationBanner implements DataPatchInterface
{
    // core config data table unused key
    const CORE_CONFIG_DATA_KEY = [
        'explorers_enable_disable_reorder_tc_notes',
        'explorers_recipient_fix',
        'explorers_notification_banner'
    ];
