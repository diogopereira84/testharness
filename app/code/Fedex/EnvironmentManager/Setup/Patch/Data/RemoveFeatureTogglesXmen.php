...
class RemoveFeatureTogglesXmen implements DataPatchInterface
{
    // core config data table unused key
    public const CORE_CONFIG_DATA_KEY = [
        'xmen_megamenu_administration_improvement',
        'xmen_missed_use_case_fedex_account',
        'xmen_hco_price_subtotal'
    ];
