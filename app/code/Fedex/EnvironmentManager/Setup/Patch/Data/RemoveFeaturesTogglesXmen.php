...
class RemoveFeaturesTogglesXmen implements DataPatchInterface
{
    // core config data table unused key
    public const CORE_CONFIG_DATA_KEY = [
        'xmen_legacy_catalog_enable_store',
        'xmen_fedex_account_apply_checkout',
        'xmen_shipping_result_collapse_fix',
    ];
