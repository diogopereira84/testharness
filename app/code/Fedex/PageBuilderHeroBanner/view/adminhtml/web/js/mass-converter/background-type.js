...
define(["Magento_PageBuilder/js/utils/object"], function (_object) {
    ...
    let BackgroundType =
        ...
        function () {
            ...
            function BackgroundType() { /* TODO document why this function 'BackgroundType' is empty */ }

            let _proto = BackgroundType.prototype;
            ...
            _proto.toDom = function toDom(data, config) {
                let backgroundType = (0, _object.get)(data, config.attribute_name);

                if (backgroundType === "video") {
                    (0, _object.set)(data, config.desktop_image_variable, []);
                    (0, _object.set)(data, config.mobile_image_variable, []);
                    (0, _object.set)(data, config.desktop_medium_image_variable, []);
                    (0, _object.set)(data, config.mobile_medium_image_variable, []);
