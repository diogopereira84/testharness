 ...
 */
 ...
 define([
    ...
    let discount = window.checkoutConfig.quoteData != undefined ? window.checkoutConfig.quoteData.discount : null;

    return Component.extend({
        defaults: {
            template: 'Fedex_Cart/summary/discount'
        },
