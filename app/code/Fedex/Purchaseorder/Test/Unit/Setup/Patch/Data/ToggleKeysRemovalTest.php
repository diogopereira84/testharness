...
use Fedex\Purchaseorder\Setup\Patch\Data\ToggleKeysRemoval;

class ToggleKeysRemovalTest extends TestCase
{
    /**
     * @var ToggleKeysRemoval
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new ToggleKeysRemoval($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(ToggleKeysRemoval::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
