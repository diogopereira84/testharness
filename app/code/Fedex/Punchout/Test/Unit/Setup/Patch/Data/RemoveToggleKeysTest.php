...
use Fedex\Punchout\Setup\Patch\Data\RemoveToggleKeys;

class RemoveToggleKeysTest extends TestCase
{
    /**
     * @var RemoveToggleKeys
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new RemoveToggleKeys($this->setup);
    }
    ...
    {
        $this->connection->expects($this->exactly(count(RemoveToggleKeys::CORE_CONFIG_DATA_KEY)))
            ->method('delete')
            ->with(
                $this->equalTo(null),
                true
