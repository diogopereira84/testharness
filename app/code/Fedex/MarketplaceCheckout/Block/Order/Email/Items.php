<?php
namespace Fedex\MarketplaceCheckout\Block\Order\Email;
...
class Items extends Template implements OrderItemsInterface
{
    ...
    protected $_template = 'Fedex_MarketplaceCheckout::email/items.phtml';
    ...
    {
        return (bool) $this->marketplaceCheckoutHelper->isCBBToggleEnabled();
    }
    ...
    {
        return $this->marketPlacehelper->isFreightShippingEnabled();
    }
    ...
    {
        return $this->marketPlacehelper->getFreightShippingSurchargeText();
    }
}
