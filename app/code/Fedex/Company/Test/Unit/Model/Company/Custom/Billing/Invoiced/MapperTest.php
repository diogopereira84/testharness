...
namespace Fedex\Company\Test\Unit\Model\Company\Custom\Billing\Invoiced;
...
use Fedex\Company\Api\Data\CustomBillingInvoicedInterfaceFactory;
use Fedex\Company\Api\Data\CustomBillingInvoicedInterface;
use Magento\Framework\Serialize\JsonValidator;
use Magento\Framework\Serialize\Serializer\Json;
use Fedex\Company\Model\Company\Custom\Billing\Invoiced\Mapper;
use Fedex\Company\Model\Company\Custom\Billing\Invoiced\CollectionFactory;
use Fedex\Company\Model\Company\Custom\Billing\Invoiced\Collection;
...
class MapperTest extends TestCase
{
    ...
    /**
     * @var CustomBillingInvoicedInterfaceFactory|MockObject
     */
    private CustomBillingInvoicedInterfaceFactory|MockObject $customBillingInvoicedFactoryMock;

    /**
     * @var CustomBillingInvoicedInterface|MockObject
     */
    private CustomBillingInvoicedInterface|MockObject $customBillingInvoicedMock;
    ...
    protected function setUp(): void
    {
        ...
        $invoice = (new ObjectManager($this))->getObject(Invoiced::class);
        $invoice->setData(self::ARRAY_VALUE[0]);
        $this->customBillingInvoicedMock = $this->getMockForAbstractClass(
            CustomBillingInvoicedInterface::class
        );
        $this->customBillingInvoicedFactoryMock = $this->getMockBuilder(
            CustomBillingInvoicedInterfaceFactory::class
        )->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();
        $this->customBillingInvoicedFactoryMock
            ->expects($this->any())
            ->method('create')
            ->willReturn($invoice);
