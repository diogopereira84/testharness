...
class Invoiced extends DataObject implements CustomBillingInvoicedInterface
{
    /**
     * Record id field key
     */
     ...
     * @inheritDoc
     */
    public function setRecordId(string $recordId): CustomBillingInvoicedInterface
    {
     ...
     * @inheritDoc
     */
    public function setFieldName(string $fieldName): CustomBillingInvoicedInterface
    {
     ...
     * @inheritDoc
     */
    public function setFieldLabel(string $fieldLabel): CustomBillingInvoicedInterface
    {
     ...
     * @inheritDoc
     */
    public function setDefault(string $default): CustomBillingInvoicedInterface
    {
     ...
     * @inheritDoc
     */
    public function setVisible(string $visible): CustomBillingInvoicedInterface
    {
     ...
     * @inheritDoc
     */
    public function setEditable(string $editable): CustomBillingInvoicedInterface
    {
     ...
     * @inheritDoc
     */
    public function setRequired(string $required): CustomBillingInvoicedInterface
    {
     ...
     * @inheritDoc
     */
    public function setMask(string $mask): CustomBillingInvoicedInterface
    {
     ...
     * @inheritDoc
     */
    public function setCustomMask(string $customMask): CustomBillingInvoicedInterface
    {
     ...
     * @inheritDoc
     */
    public function setErrorMessage(string $errorMessage): CustomBillingInvoicedInterface
    {
