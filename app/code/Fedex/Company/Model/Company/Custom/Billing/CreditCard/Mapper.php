...
namespace Fedex\Company\Model\Company\Custom\Billing\CreditCard;
...
class Mapper
{
     ...
     *
     * @param CustomBillingCreditCardInterfaceFactory $billingInvoicedFactory
     * @param CollectionFactory                     $collectionFactory
     * @param Json                                  $json
     * @param JsonValidator                         $jsonValidator
     */
    public function __construct(
        private readonly CustomBillingCreditCardInterfaceFactory $billingInvoicedFactory,
    ...
    private function map(Collection $collection, array $data): void
    {
        foreach ($data as $item) {
            $collection->addItem(
                $this->billingInvoicedFactory->create([
                    'data' => $item
                ])
            );
        }
