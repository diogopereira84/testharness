...
define([
    ...
    $.widget('mage.autoComplete', {
        ...
        _sendAjax: function () {
            ...
            if (this.options.currentElement == 'general[store_view_id]') {
                var sendData = {
                    name: this.blocks.inputBlock.val(),
                    store_id: $('input[name="general[store_id]"]').val()
                };
            }
            else if (this.options.currentElement == 'general[new_store_view_id]') {
                var sendData = {
                    name: this.blocks.inputBlock.val(),
                    new_store_id: $('input[name="general[new_store_id]"]').val()
                };
            }
            else {
                var sendData = {
