...
use Magento\NegotiableQuote\Block\Quote\View;
use Fedex\Orderhistory\Helper\Data;
use Magento\Framework\App\Request\Http;
use Magento\Framework\UrlInterface;
use Fedex\Orderhistory\Plugin\Frontend\Magento\NegotiableQuote\Block\Quote\View as PluginView;
...
class ViewTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->http = $this->getMockBuilder(Http::class)
                                        ->disableOriginalConstructor()
                                        ->getMock();
        $this->pluginFilterMock = $this->getMockBuilder(View::class)
