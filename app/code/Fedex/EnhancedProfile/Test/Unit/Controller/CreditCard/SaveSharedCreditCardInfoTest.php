...
use Fedex\EnhancedProfile\Controller\CreditCard\SaveSharedCreditCardInfo;
...
class SaveSharedCreditCardInfoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->saveInfoMock = $this->objectManager->getObject(
            SaveSharedCreditCardInfo::class,
            [
                'context' => $context,
