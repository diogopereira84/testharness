...
var Int10 = (typeof module !== 'undefined') ? require('./int10.js') : window.Int10,
	...
	// modification by Stephen Oberholtzer (stevie at qrpff dot net)
	Stream.prototype.getRange = function (start, end) {
	...
	// rawContent added by Stephen Oberholtzer (stevie at qprff dot net) to simplify decoding
	ASN1.prototype.rawContent = function() {
	    var content = this.posContent(),
	        len = Math.abs(this.length);
		return this.stream.getRange(content, content + len);
	};
