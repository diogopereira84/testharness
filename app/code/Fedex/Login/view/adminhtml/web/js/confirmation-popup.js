                        ...
                        confirm: function () {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    var impersinator_toggle= $('body').hasClass('mazegeeks_ctc_admin_impersonator');
                                    if (data.message) {
                                        messages.push(data.message);
                                    }
                                     if (data.login_error && impersinator_toggle && data.redirectUrl) {
                                        window.location.href = data.redirectUrl;
                                     } else if (data.redirectUrl) {                              
                                        data.redirectUrl = data.redirectUrl.replace("/default","/ondemand");
