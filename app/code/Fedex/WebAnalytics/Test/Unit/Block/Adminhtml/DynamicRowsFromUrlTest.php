...
use Fedex\WebAnalytics\Block\Adminhtml\DynamicRowsFromUrl;
use Fedex\WebAnalytics\Block\Adminhtml\Form\Field\Widget\DynamicRowsFromUrl as DynamicRowsFromUrlField;
...
class DynamicRowsFromUrlTest extends TestCase
{
     ...
     */
    protected DynamicRowsFromUrl $dynamicRowsFromUrl;
    protected function setUp(): void
    {
        ...
        $this->blockInterface = $this->getMockBuilder(DynamicRowsFromUrlField::class)
            ->disableOriginalConstructor()
            ->setMethods(["toHtml"])
            ->getMock();
        ...
        $this->dynamicRowsFromUrl = $objectManager->getObject(
            DynamicRowsFromUrl::class,
            [
    ...
    public function testPrepareElementHtml()
    {
        ...
        $this->assertNotNull($this->dynamicRowsFromUrl->prepareElementHtml($this->abstractElement));
    }
}
