...
namespace Fedex\FXOPricing\Test\Unit\Model\RateQuote;
...
class DetailBuilderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->detailFactoryMock = $this->getMockBuilder(RateQuoteDetailInterfaceFactory::class)
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();
        $this->detailFactoryMock->method('create')
            ->willReturn(new Detail($this->deliveryLineCollectionFactoryMock, $this->discountCollectionFactoryMock));
        $this->deliveryLineBuilderMock = $this->getMockForAbstractClass(RateQuoteDeliveryLineBuilderInterface::class);
        $this->deliveryLineMock = $this->createMock(DeliveryLine::class);
        $this->discountBuilderMock = $this->getMockForAbstractClass(RateQuoteDiscountBuilderInterface::class);
    ...
    public function testBuild(): void
    {
        ...
        $this->assertInstanceOf(RateQuoteDeliveryLineCollectionInterface::class, $detail->getDeliveryLines());
        $this->assertInstanceOf(RateQuoteDiscountCollectionInterface::class, $detail->getDiscounts());
