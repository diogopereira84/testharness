...
use Fedex\FXOPricing\Model\RateQuote\Detail\DeliveryLineBuilder;
...
class DeliveryLineBuilderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->deliveryLineFactoryMock = $this->getMockBuilder(RateQuoteDeliveryLineInterfaceFactory::class)
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testBuild(): void
    {
        ...
        $this->assertInstanceOf(RateQuoteDeliveryLineDiscountCollectionInterface::class, $deliveryLine->getDeliveryLineDiscounts());
