...
namespace Fedex\FXOPricing\Test\Unit\Model\Rate\Detail\DeliveryLine;
...
class DiscountBuilderTest extends TestCase
{
    ...
    /**
     * @var MockObject|RateDeliveryLineDiscountInterfaceFactory
     */
    private MockObject|RateDeliveryLineDiscountInterfaceFactory $discountFactoryMock;
    ...
    {
        $this->discountFactoryMock = $this->getMockBuilder(RateDeliveryLineDiscountInterfaceFactory::class)
            ->setMethods(['create'])
