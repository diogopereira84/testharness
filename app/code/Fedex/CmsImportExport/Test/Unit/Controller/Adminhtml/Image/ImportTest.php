...
namespace Fedex\CmsImportExport\Test\Unit\Controller\Adminhtml\Image;

use Fedex\CmsImportExport\Controller\Adminhtml\Image\Import;
...
class ImportTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->pageTitle->expects($this->any())->method('prepend')
            ->with(__('Import CMS Content Images'))
            ->willReturn($this->cmsPageMock);
