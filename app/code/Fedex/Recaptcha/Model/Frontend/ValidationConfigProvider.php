...
namespace Fedex\Recaptcha\Model\Frontend;
...
{
    public const XML_PATH_PRIVATE_KEY = 'recaptcha_frontend/type_recaptcha_v3/private_key';
    public const XML_PATH_VALIDATION_FAILURE = 'recaptcha_frontend/type_recaptcha_v3/validation_failure_message';
    public const XML_PATH_SCORE_THRESHOLD = 'recaptcha_frontend/type_recaptcha_v3/score_threshold';
    ...
    public function __construct(
        ...
        protected ValidationConfigInterfaceFactory $validationConfigFactory,
        protected ValidationConfigExtensionFactory $validationConfigExtensionFactory
    ) {
    }
    ...
    {
        return trim((string)$this->scopeConfig->getValue(self::XML_PATH_PRIVATE_KEY, ScopeInterface::SCOPE_STORE));
    }
