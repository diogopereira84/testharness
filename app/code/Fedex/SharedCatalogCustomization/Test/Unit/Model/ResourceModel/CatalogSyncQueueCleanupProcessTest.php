...
use Fedex\SharedCatalogCustomization\Model\ResourceModel\CatalogSyncQueueCleanupProcess;
...
class CatalogSyncQueueCleanupProcessTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->_resourceModel = new CatalogSyncQueueCleanupProcess($contextMock);
    }
