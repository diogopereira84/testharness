...
use Fedex\SharedCatalogCustomization\Controller\Adminhtml\Manual\CatalogPriceSync;
...
class CatalogPriceSyncTest extends TestCase
{
    ...
    {
        $this->catalogSyncMock = $this->createMock(CatalogPriceSync::class);
