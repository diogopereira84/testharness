...
namespace Fedex\SharedCatalogCustomization\Test\Unit\Controller\Adminhtml\Grid;

use Fedex\SharedCatalogCustomization\Controller\Adminhtml\Grid\Index;
...
class IndexTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->cmsPageMock->expects($this->once())
            ...
            ->with('Fedex_SharedCatalogCustomization::index')
            ->willReturnSelf();
        ...
        $this->pageTitle->expects($this->once())->method('prepend')->with(__('Catalog sync grid'))->willReturn($this->cmsPageMock);
