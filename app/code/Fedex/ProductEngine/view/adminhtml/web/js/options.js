    ...
    return function (config) {
        var optionPanel = jQuery('#manage-options-panel'),
            ...
            attributeOption = {
                ...
                templateNew: mageTemplate('#new-row-template'),
        ...
        if ($('add_new_option_button')) {
            Event.observe('add_new_option_button', 'click', attributeOption.addNew.bind(attributeOption, {}, true));
        }
