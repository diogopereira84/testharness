...
//force valueof to match the Java's behavior
        ...
        var ProductRelation = function() {};
        stjs.extend(ProductRelation, null, [], function(constructor, prototype) {
        ...
        var ElementType = stjs.enumeration("PRODUCT", "INSERT", "EXCEPTION", "ADDON", "PAGEEXCEPTION");
        ...
        var ValidationResultCode = stjs.enumeration("PROPERTY_VALUE_REQUIRED", "PROPERTY_VALUE_MIN_REQUIRED", "PROPERTY_VALUE_MAX_EXCEEDED", "PROPERTY_VALUE_NOT_ALLOWED", "PROPERTY_VALUE_FORMAT_INVALID", "FEATURE_NOT_SELECTABLE", "CHOICE_NOT_SELECTABLE", "PROPERTY_NOT_ALLOWED", "FEATURE_REQUIRED", "CHOICE_REQUIRED", "PROPERTY_REQUIRED", "INSERT_FEATURE_REQUIRED", "INSERT_POSITION_REQUIRED", "INSERT_PAGE_NUMBER_REQUIRED", "INSERT_PAGE_NUMBER_INVALID", "EXCEPTION_PAGE_RANGE_REQUIRED", "EXCEPTION_FEATURE_REQUIRED", "EXCEPTION_START_PAGE_INVALID", "EXCEPTION_END_PAGE_INVALID", "EXCEPTION_NOT_SELECTABLE", "PAGE_EXCEPTION_PAGE_RANGE_INVALID", "ADDON_FEATURE_REQUIRED", "ADDON_POSITION_REQUIRED", "ADDON_PAGE_NUMBER_REQUIRED", "ADDON_PAGE_NUMBER_INVALID", "CONTENT_PAGE_COUNT_MAX_EXCEEDED", "CONTENT_PAGE_COUNT_MIN_REQUIRED", "CONTENT_FILE_SIZE_MAX_EXCEEDED", "CONTENT_MORE_FILES_ALLOWED", "CONTENT_PAGE_SIZE_INVALID", "CONTENT_PAGE_SIZE_MIXED_NOT_ALLOWED", "CONTENT_ORIENTATION_MIXED_NOT_ALLOWED", "CONTENT_PRINT_READY_REQUIRED", "CONTENT_FILE_COUNT_MAX_EXCEEDED", "CONTENT_REQUIREMENT_PURPOSE_REQUIRED", "CONTENT_REFERENCE_INVALID", "CONTENT_NOT_ALLOWED", "PRODUCT_ID_REQUIRED", "FEATURE_ID_REQUIRED", "CHOICE_ID_REQUIRED", "PROPERTY_ID_REQUIRED", "PRODUCT_ID_INVALID", "PRODUCT_ID_VERSION_INVALID", "PRODUCT_PROCESSING_ERROR", "PRODUCT_INTERNAL_ERROR", "FEATURE_ID_INVALID", "CHOICE_ID_INVALID", "PROPERTY_ID_INVALID", "CONTENT_REQUIREMENT_ID_INVALID", "CONTENT_REQUIREMENT_ID_REQUIRED", "CONTENT_REQUIREMENT_REQUIRED", "PRODUCT_QUANTITY_INVALID", "CONTENT_REFERENCE_OR_PAGE_GROUP_REQUIRED", "CONTENT_PAGE_GROUP_INVALID", "DUPLICATE_PRODUCT_ELEMENT");
        ...
        var ProductType = stjs.enumeration("PRINT", "RETAIL", "SERVICE");
        ...
        var ProductRelationType = stjs.enumeration("CROSS_SELL", "UP_SELL", "CUSTOMIZE");
        ...
        }, {map: {name: "Map", arguments: [null, "RuleType"]}, DEFAULT_SELECTION: "RuleType", VALIDATION: "RuleType", SKU_CODE: "RuleType", REQUIRED: "RuleType", AVAILABLE: "RuleType", VALUE: "RuleType", ASSOCIATE_TEXT: "RuleType", PRICEABLE: "RuleType", OVERRIDE_DEFAULT: "RuleType", OVERRIDE_DEFAULT_FLAG: "RuleType", SKU_REFERENCE: "RuleType", SKU_QTY: "RuleType", SKU_UNIT_QTY: "RuleType", SKU_DSC_LOOKUP_QTY: "RuleType", PROOF_FLAG: "RuleType", PRODUCTION_TIME: "RuleType", OUTSOURCE: "RuleType", PRODUCT_QTY: "RuleType", WEIGHT_QTY: "RuleType", DLT_EXPRESSION: "RuleType", PROD_TIME_QTY: "RuleType", PRODUCTION_QTY: "RuleType"});
        ...
        (function() {
            ...
            ValidationResultMappings.descMap.put(ValidationResultCode.INSERT_FEATURE_REQUIRED, "Feature is required for Insert");
            ValidationResultMappings.descMap.put(ValidationResultCode.INSERT_POSITION_REQUIRED, "Position is required for Insert");
            ValidationResultMappings.descMap.put(ValidationResultCode.INSERT_PAGE_NUMBER_REQUIRED, "Page Number is required for Insert");
            ValidationResultMappings.descMap.put(ValidationResultCode.INSERT_PAGE_NUMBER_INVALID, "Page Number is invalid");
            ...
            ValidationResultMappings.descMap.put(ValidationResultCode.ADDON_FEATURE_REQUIRED, "Feature is required for AddOn");
            ValidationResultMappings.descMap.put(ValidationResultCode.ADDON_POSITION_REQUIRED, "Position is required for AddOn");
            ValidationResultMappings.descMap.put(ValidationResultCode.ADDON_PAGE_NUMBER_REQUIRED, "Page Number is required for AddOn");
            ValidationResultMappings.descMap.put(ValidationResultCode.ADDON_PAGE_NUMBER_INVALID, "Page Number is invalid");
            ...
            ValidationResultMappings.severityMap.put(ValidationResultCode.INSERT_FEATURE_REQUIRED, ValidationSeverity.ERROR);
            ValidationResultMappings.severityMap.put(ValidationResultCode.INSERT_POSITION_REQUIRED, ValidationSeverity.ERROR);
            ValidationResultMappings.severityMap.put(ValidationResultCode.INSERT_PAGE_NUMBER_REQUIRED, ValidationSeverity.ERROR);
            ValidationResultMappings.severityMap.put(ValidationResultCode.INSERT_PAGE_NUMBER_INVALID, ValidationSeverity.ERROR);
            ...
            ValidationResultMappings.severityMap.put(ValidationResultCode.ADDON_FEATURE_REQUIRED, ValidationSeverity.ERROR);
            ValidationResultMappings.severityMap.put(ValidationResultCode.ADDON_POSITION_REQUIRED, ValidationSeverity.ERROR);
            ValidationResultMappings.severityMap.put(ValidationResultCode.ADDON_PAGE_NUMBER_REQUIRED, ValidationSeverity.ERROR);
            ValidationResultMappings.severityMap.put(ValidationResultCode.ADDON_PAGE_NUMBER_INVALID, ValidationSeverity.ERROR);
        ...
        }, {allowedSizes: {name: "List", arguments: ["ContentDimensions"]}, contentReferences: {name: "List", arguments: [null]}});
        ...
        stjs.extend(Product, AbstractProduct, [], function(constructor, prototype) {
            ...
            prototype.removeContentRequirement = function(cr) {};
            prototype.getSku = function() {
                return this.sku;
            };
            prototype.setSku = function(sku) {
                this.sku = sku;
            };
            prototype.getSkuQty = function() {
                return this.skuQty;
            };
            prototype.setSkuQty = function(skuQty) {
                this.skuQty = skuQty;
            };
            prototype.getWeight = function() {
                return this.weight;
            ...
            prototype.getProductType = function() {
                return this.productType;
            };
            prototype.setProductType = function(productType) {
        ...
        }, {contentRequirements: {name: "Set", arguments: ["ContentRequirement"]}, products: {name: "List", arguments: ["ProductRelation"]}, productType: {name: "Enum", arguments: ["ProductType"]}, externalRequirements: "ExternalRequirements", features: {name: "Set", arguments: ["F"]}, properties: {name: "Set", arguments: ["P"]}, pageExceptions: {name: "List", arguments: ["Pe"]}});
        ...
        }, {choices: {name: "Set", arguments: ["C"]}, contentReqRefIds: {name: "Set", arguments: [null]}});
        ...
        }, {compatibilityGroups: {name: "Set", arguments: ["CompatibilityGroup"]}, contentReqRefIds: {name: "Set", arguments: [null]}, weight: "BigDecimal", properties: {name: "Set", arguments: ["P"]}});
        ...
        }, {bounds: {name: "Set", arguments: ["Bound"]}});
        ...
        stjs.extend(TotalPageCountProvider, AbstractValueProvider, [], function(constructor, prototype) {
            prototype.getValueOfType = function(context, desiredOutputValueType) {
                ...
                for (var pe in context.getProduct().getPageExceptions()) {
        ...
        stjs.extend(ChoiceProvider, AbstractValueProvider, [], function(constructor, prototype) {
            ...
            prototype.getValueOfType = function(context, desiredOutputValueType) {
                return ValueConverter.convertToLong(this.choiceId, ValueType.LONG);
            };
            prototype.getType = function() {
                return ValueType.LONG;
            };
        ...
        stjs.extend(ConfiguredProduct, Product, [], null, {contentRequirements: {name: "Set", arguments: ["ContentRequirement"]}, products: {name: "List", arguments: ["ProductRelation"]}, productType: {name: "Enum", arguments: ["ProductType"]}, externalRequirements: "ExternalRequirements", features: {name: "Set", arguments: ["F"]}, properties: {name: "Set", arguments: ["P"]}, pageExceptions: {name: "List", arguments: ["Pe"]}});
        ...
        var ProductException = function() {
            this.ranges = new ArrayList();
            this.features = new ArraySet();
            this.featureIdMap = new ArrayMap();
        };
        stjs.extend(ProductException, null, [FeatureInstanceContainer], function(constructor, prototype) {
            prototype.ranges = null;
            prototype.features = null;
        ...
        }, {ranges: {name: "List", arguments: ["PageRange"]}, features: {name: "Set", arguments: ["FeatureInstance"]}, featureIdMap: {name: "Map", arguments: [null, "FeatureInstance"]}});
        ...
        var ProductAddOn = function() {};
        stjs.extend(ProductAddOn, null, [FeatureInstanceContainer], function(constructor, prototype) {
            prototype.pageNumber = 0;
            prototype.position = null;
            prototype.feature = null;
            prototype.addFeature = function(feature) {
                this.setFeature(feature);
            };
            prototype.containsFeature = function(featureId) {
                if (this.feature != null && this.feature.getId() != null && this.feature.getId() == featureId)
                    return true;
                return false;
            };
            prototype.getFeatureById = function(featureId) {
                if (this.feature != null && this.feature.getId() != null && this.feature.getId() == featureId)
                    return this.feature;
                return null;
            };
            prototype.containsChoice = function(choiceId) {
                if (this.feature != null)
                    return this.feature.getChoice().getId() == choiceId;
                return false;
            };
            prototype.getChoiceById = function(choiceId) {
                if (this.feature != null) {
                    if (this.feature.getChoice().getId() == choiceId) {
                        return this.feature.getChoice();
                    }
                }
                return null;
            };
            ...
            prototype.setFeature = function(feature) {
                this.feature = feature;
            };
            prototype.removeFeature = function(feature) {
                return false;
            };
        }, {position: {name: "Enum", arguments: ["InsertPosition"]}, feature: "FeatureInstance"});

        var ProductInsert = function() {
            this.features = new ArraySet();
            this.featureIdMap = new ArrayMap();
        };
        stjs.extend(ProductInsert, null, [FeatureInstanceContainer], function(constructor, prototype) {
            prototype.pageNumber = 0;
            prototype.position = null;
            prototype.features = null;
            prototype.featureIdMap = null;
            ...
            prototype.containsFeatureChoice = function(featureId, choiceId) {
                var feature = this.featureIdMap.get(featureId);
                if (feature != null) {
                    return (feature.getChoice().getId() == choiceId);
                }
                return false;
            };
            prototype.getChoiceById = function(choiceId) {
        ...
        }, {position: {name: "Enum", arguments: ["InsertPosition"]}, features: {name: "Set", arguments: ["FeatureInstance"]}, featureIdMap: {name: "Map", arguments: [null, "FeatureInstance"]}});
        ...
        stjs.extend(AbstractProductData, null, [], function(constructor, prototype) {
            ...
            prototype.crossSellProducts = null;
            prototype.upSellProducts = null;
            ...
            prototype.getCrossSellProducts = function() {
                return this.crossSellProducts;
            };
            prototype.setCrossSellProducts = function(crossSellProducts) {
                this.crossSellProducts = crossSellProducts;
            };
            prototype.getUpSellProducts = function() {
                return this.upSellProducts;
            };
            prototype.setUpSellProducts = function(upSellProducts) {
                this.upSellProducts = upSellProducts;
            };
        }, {product: "Product", rules: "ProductRules", displays: "ProductDisplays", presets: {name: "Set", arguments: ["Preset"]}, crossSellProducts: {name: "List", arguments: ["ProductRelation"]}, upSellProducts: {name: "List", arguments: ["ProductRelation"]}});

        var PageExceptionProcessor = function() {};
        stjs.extend(PageExceptionProcessor, null, [], function(constructor, prototype) {
            prototype.convertLegacyModelToPageException = function(pi, cPageEx) {
                var exInstances = new ArrayList();
                ...
                var cPageExItr = cPageEx.iterator();
                var pit = null;
                while (cPageExItr.hasNext()){
                    cpe = cPageExItr.next();
                    var ids = new ArrayList();
                    ids.add(cpe.getId());
                    pit = cpe.getProperties().iterator();
                    while (pit.hasNext()){
                        ids.add(pit.next().getId());
                    }
                    map.put(cpe.getName(), ids);
                }
                var caIt = pi.getContentAssociations().iterator();
                while (caIt.hasNext()){
                    ca = caIt.next();
                    var start = 0, end = 0;
                    var pgIt = ca.getPageGroups().iterator();
                    while (pgIt.hasNext()){
                        pg = pgIt.next();
                        if (start == 0 || start > pg.getStart()) {
                            start = pg.getStart();
                        }
                        if (end == 0 || end > pg.getEnd()) {
                            end = pg.getEnd();
                        }
                        pageRange = new PageRange();
                        pageRange.setStart(start + pageCount);
                        pageRange.setEnd(end + pageCount);
                        pageCount = pageCount + (end - start) + 1;
                        pageRanges.add(pageRange);
                        exInstances.add(null);
                    }
                }
                var insertIt = pi.getInserts().iterator();
                while (insertIt.hasNext()){
                    var insert = insertIt.next();
                    if (insert.getPosition() != null && insert.getPageNumber() > 0 && insert.getFeatures().size() > 0) {
                        this.splitPageRange(insert.getPosition().toString(), insert.getPageNumber(), pageRanges, exInstances, insert, null, map);
                    }
                }
                var addOnIt = pi.getAddOns().iterator();
                while (addOnIt.hasNext()){
                    var addOn = addOnIt.next();
                    if (addOn.getPosition() != null && addOn.getPageNumber() > 0 && addOn.getFeature() != null) {
                        this.splitPageRange(addOn.getPosition().toString(), addOn.getPageNumber(), pageRanges, exInstances, null, addOn, map);
                    }
                }
                ...
                for (var i = 0; i < pageRanges.size(); i++) {
                    pageRange = pageRanges.get(i);
                    if (pageRange.getStart() == 0) {
                        var page = i == 0 ? 1 : (pageRanges.get(i - 1).getEnd() + 1);
                        var range = new PageRange();
                        range.setStart(page);
                        range.setEnd(page);
                        var ranges = new ArrayList();
                        ranges.add(range);
                        exInstances.get(i).setRanges(ranges);
                        for (var j = i + 1; j < pageRanges.size(); j++) {
                            pageRange = pageRanges.get(j);
                            if (pageRange.getStart() != 0) {
                                pageRange.setStart(pageRange.getStart() + 1);
                                pageRange.setEnd(pageRange.getEnd() + 1);
                            }
                        }
                    }
                }
                var productExIt = pi.getExceptions().iterator();
                while (productExIt.hasNext()){
                    ex = productExIt.next();
                    if (ex.getRanges().size() > 0 && ex.getFeatures().size() > 0) {
                        var exeRanges = new ArrayList();
                        var rangeIt = ex.getRanges().iterator();
                        while (rangeIt.hasNext()){
                            var range = rangeIt.next();
                        ...
                        var peInstance = new PageExceptionInstance();
                        var p = new PropertyInstance();
                        var ids = map.get("Printing Exceptions");
                        p.setId(ids.get(1));
                        p.setName("EXCEPTION_TYPE");
                        p.setValue("PRINT_EXCEPTION");
                        peInstance.getProperties().add(p);
                        peInstance.getFeatures().addAll(ex.getFeatures());
                        peInstance.setHasContent(true);
                        peInstance.setId(ids.get(0));
                        peInstance.setRanges(exeRanges);
                        exInstances.add(peInstance);
                    }
                }
                pi.getPageExceptions().clear();
                for (var i = 0; i < exInstances.size(); i++) {
                    if (exInstances.get(i) != null) {
                        pi.addPageException(exInstances.get(i));
                    }
                }
            };
            prototype.splitPageRange = function(position, pageNumber, newRanges, exInstances, insert, addOn, map) {
                var index = 0;
                var range1 = null;
                var range2 = null;
                var range3 = null;
                var peInstance = new PageExceptionInstance();
                if (insert != null) {
                    var ids = map.get("Insert");
                    var p = new PropertyInstance();
                    p.setId(ids.get(1));
                    p.setName("EXCEPTION_TYPE");
                    p.setValue("INSERT");
                    peInstance.getProperties().add(p);
                    peInstance.getFeatures().addAll(insert.getFeatures());
                    peInstance.setHasContent(false);
                    peInstance.setId(ids.get(0));
                } else if (addOn != null) {
                    var ids = map.get("Tab");
                    var ap = new PropertyInstance();
                    ap.setId(ids.get(1));
                    ap.setName("EXCEPTION_TYPE");
                    ap.setValue("TAB");
                    peInstance.getProperties().add(ap);
                    if (addOn.getFeature() != null) {
                        peInstance.getFeatures().add(addOn.getFeature());
                    }
                    peInstance.setHasContent(false);
                    peInstance.setId(ids.get(0));
                }
                var pgItr = newRanges.iterator();
                while (pgItr.hasNext()){
                    var range = pgItr.next();
                    if (pageNumber == range.getStart()) {
                        if (position.equals("AFTERPAGE")) {
                            range1 = new PageRange();
                            range1.setStart(range.getStart());
                            range1.setEnd(range.getStart());
                            ...
                            newRanges.remove(index);
                            Utils.addRangeToList(index, range3, newRanges);
                            Utils.addRangeToList(index, range2, newRanges);
                            Utils.addRangeToList(index, range1, newRanges);
                            exInstances.remove(index);
                            Utils.addPageExceptionToList(index, null, exInstances);
                            Utils.addPageExceptionToList(index, peInstance, exInstances);
                            Utils.addPageExceptionToList(index, null, exInstances);
                            return;
                        } else if (position.equals("BEFOREPAGE")) {
                            range1 = new PageRange();
                            range1.setStart(0);
                            range1.setEnd(0);
                            Utils.addRangeToList(index, range1, newRanges);
                        ...
                        if (position.equals("AFTERPAGE")) {
                            ...
                            range1.setStart(0);
                            range1.setEnd(0);
                            Utils.addRangeToList(index + 1, range1, newRanges);
                            Utils.addPageExceptionToList(index + 1, peInstance, exInstances);
                            return;
                        } else if (position.equals("BEFOREPAGE")) {
                            range1 = new PageRange();
                            range1.setStart(range.getStart());
                            range1.setEnd(range.getEnd() - 1);
                            range2 = new PageRange();
                            range2.setStart(0);
                            range2.setEnd(0);
                            range3 = new PageRange();
                            range3.setStart(range.getEnd());
                            range3.setEnd(range.getEnd());
                            newRanges.remove(index);
                            Utils.addRangeToList(index, range3, newRanges);
                            Utils.addRangeToList(index, range2, newRanges);
            ...
            prototype.convertPageExceptionsToLegacyModel = function(pi) {
                var sortedStarts = new ArrayList();
                var sortedPges = new ArrayList();
                var inserts = new ArrayList();
                var addOns = new ArrayList();
                var exceptions = new ArrayList();
                var excepetionsNewMap = new ArrayMap();
                var insert = null;
                var addOn = null;
                var pe = null;
                var pRange = null;
                var ranges = null;
                var pgIt = pi.getPageExceptions().iterator();
                while (pgIt.hasNext()){
                    var pg = pgIt.next();
                    var rangeIt = pg.getRanges().iterator();
                    while (rangeIt.hasNext()){
                        var index = 0;
                        var range = rangeIt.next();
                        ...
                        Utils.addIntegerToList(index, range.getStart(), sortedStarts);
                        Utils.addPageExceptionToList(index, pg, sortedPges);
                    }
                }
                var insertTabCount = 0;
                var startRange = 0;
                var index = 0;
                var sortedStart = 0;
                var sortedStartsIterator = sortedStarts.iterator();
                while (sortedStartsIterator.hasNext()){
                    sortedStart = sortedStartsIterator.next();
                    var pg = sortedPges.get(index);
                    index++;
                    var rangeIt = pg.getRanges().iterator();
                    while (rangeIt.hasNext()){
                        var range = rangeIt.next();
                        if (range.getStart() == sortedStart) {
                            startRange = range.getStart();
                            var prIt = pg.getProperties().iterator();
                            while (prIt.hasNext()){
                                var pr = prIt.next();
                                if (pr.getValue().equals("INSERT") || pr.getValue().equals("TAB")) {
                                    while (startRange <= range.getEnd()){
                                        var pageNumber = startRange - insertTabCount;
                                        var position;
                                        if (pageNumber == 1) {
                                            position = InsertPosition.BEFOREPAGE;
                                        } else {
                                            position = InsertPosition.AFTERPAGE;
                                            pageNumber = pageNumber - 1;
                                        }
                                        if (pr.getValue().equals("INSERT")) {
                                            insert = new ProductInsert();
                                            insert.setPageNumber(pageNumber);
                                            insert.setPosition(position);
                                            insert.setFeatures(pg.getFeatures());
                                            inserts.add(insert);
                                        }
                                        if (pr.getValue().equals("TAB")) {
                                            addOn = new ProductAddOn();
                                            addOn.setPageNumber(pageNumber);
                                            addOn.setPosition(position);
                                            addOn.setFeature(pg.getFeatures().iterator().next());
                                            addOns.add(addOn);
                                        }
                                        insertTabCount++;
                                        startRange++;
                                    ...
                                    pe = excepetionsNewMap.get(range.getStart());
                                    pRange = new PageRange();
                                    pRange.setStart(range.getStart() - insertTabCount);
                                    pRange.setEnd(range.getEnd() - insertTabCount);
                                    if (pe == null) {
                                        ranges = new ArrayList();
                                        ranges.add(pRange);
                                        pe = new ProductException();
                                        pe.setRanges(ranges);
                                        pe.setFeatures(pg.getFeatures());
                                        exceptions.add(pe);
                                        var rgIt = pg.getRanges().iterator();
                                        while (rgIt.hasNext()){
                                            var rg = rgIt.next();
                                            if (rg.getStart() != range.getStart()) {
                                                excepetionsNewMap.put(rg.getStart(), pe);
                                            }
                                        }
                                    } else {
                                        var isRangeContinous = false;
                                        var prgIt = pe.getRanges().iterator();
                                        while (prgIt.hasNext()){
                                            var prg = prgIt.next();
                                            if (prg.getStart() == pRange.getEnd() + 1) {
                                                prg.setStart(pRange.getStart());
                                                isRangeContinous = true;
                                            } else if (prg.getEnd() == pRange.getStart() - 1) {
                                                prg.setEnd(pRange.getEnd());
                                                isRangeContinous = true;
                                            }
                                        }
                                        if (!isRangeContinous) {
                                            pe.getRanges().add(range);
                                        }
                                    }
                                }
                            }
                ...
                pi.getAddOns().addAll(addOns);
                pi.getInserts().addAll(inserts);
                pi.getExceptions().addAll(exceptions);
            };
        }, {});
        ...
        stjs.extend(ProductInstance, AbstractProduct, [FeatureInstanceContainer], function(constructor, prototype) {
            prototype.instanceId = null;
            prototype.userProductName = null;
            prototype.inserts = null;
            prototype.exceptions = null;
            prototype.addOns = null;
            prototype.contentAssociations = null;
            /**
            ...
            prototype.getInserts = function() {
                return this.inserts;
            };
            prototype.setInserts = function(inserts) {
                this.inserts = inserts;
            };
            prototype.getExceptions = function() {
                return this.exceptions;
            };
            prototype.setExceptions = function(exceptions) {
                this.exceptions = exceptions;
            };
            prototype.getAddOns = function() {
                return this.addOns;
            };
            prototype.setAddOns = function(addOns) {
                this.addOns = addOns;
            };
            prototype.getContentAssociations = function() {
                return this.contentAssociations;
            ...
            prototype.addInsert = function(insert) {
                this.getInserts().add(insert);
            };
            prototype.removeInsert = function(insert) {
                var index = this.getInserts().indexOf(insert);
                this.getInserts().remove(index);
            };
            prototype.removeInsertAt = function(index) {
                this.getInserts().remove(index);
            };
            prototype.addException = function(exception) {
                this.getExceptions().add(exception);
            };
            prototype.removeException = function(exception) {
                var index = this.getExceptions().indexOf(exception);
                this.getExceptions().remove(index);
            };
            prototype.removeExceptionAt = function(index) {
                this.getExceptions().remove(index);
            };
            prototype.addAddOn = function(addOn) {
                this.getAddOns().add(addOn);
            };
            prototype.removeAddOn = function(addOn) {
                var index = this.getAddOns().indexOf(addOn);
                this.getAddOns().remove(index);
            };
            prototype.removeAddOnAt = function(index) {
                this.getAddOns().remove(index);
            };
        ...
        }, {product: "ProductInstance", selectedChoiceIds: {name: "Set", arguments: [null]}, defaultOverrideChoiceIds: {name: "Set", arguments: [null]}, contextMap: {name: "Map", arguments: [null, "Object"]}, refIds: {name: "List", arguments: [null]}, pageException: "PageExceptionInstance"});
        ...
        stjs.extend(ProductConfigurationProcessor, null, [], function(constructor, prototype) {
            prototype.getConfiguredProduct = function(product, productRules, context) {
                ...
                configProduct.setProductType(product.getProductType());
            ...
            prototype.getConfiguredFeature = function(feature, productRules, context, cgInstanceMap, product) {
                ...
                var crIt = feature.getContentReqRefIds().iterator();
                var crRefIds = new ArraySet();
                while (crIt.hasNext()){
                    crRefIds.add(crIt.next());
                }
                configFeature.setContentReqRefIds(crRefIds);
            ...
            prototype.getConfiguredChoice = function(choice, productRules, context, cgInstanceMap) {
                ...
                configChoice.setSku(choice.getSku());
                configChoice.setSkuQty(choice.getSkuQty());
                var configuredProperties = new ArraySet();
                ...
                var configuredCrs = new ArraySet();
                var crIt = choice.getContentReqRefIds().iterator();
                while (crIt.hasNext()){
                    configuredCrs.add(crIt.next());
                }
                configChoice.setContentReqRefIds(configuredCrs);
            ...
            prototype.getConfiguredProductRelations = function(relations, productRules, context) {
                var pr = null;
                var configuredRelations = new ArrayList();
                try {
                    var it = relations.iterator();
                    while (it.hasNext()){
                        pr = it.next();
                        if (this.isEntitySelectable(pr.getProductId(), productRules, context, true)) {
                            configuredRelations.add(pr.clone());
                        }
                    }
                }catch (e) {
                    throw new ProductConfigProcessorException(Utils.getExceptionMessage(e), e);
            ...
            prototype.addValidationResultsFromPageExceptions = function(pi, cfgPges, results) {
                ...
                while (peit.hasNext()){
                    ...
                    if (cfgPge == null || !cfgPge.isSelectable()) {
                        results.add(this.createValidationResult(ValidationResultCode.EXCEPTION_NOT_SELECTABLE, pgei.getId(), ElementType.EXCEPTION, index));
                    } else {
                        if (pgei.getRanges().isEmpty()) {
                            results.add(this.createValidationResult(ValidationResultCode.EXCEPTION_PAGE_RANGE_REQUIRED, null, ElementType.EXCEPTION, index));
                        } else {
                            prit = pgei.getRanges().iterator();
                            while (prit.hasNext()){
                                range = prit.next();
                                if (range.getStart() > range.getEnd()) {
                                    results.add(this.createValidationResult(ValidationResultCode.EXCEPTION_START_PAGE_INVALID, null, ElementType.EXCEPTION, index));
                                }
                                if (range.getEnd() < range.getStart()) {
                                    results.add(this.createValidationResult(ValidationResultCode.EXCEPTION_END_PAGE_INVALID, null, ElementType.EXCEPTION, index));
                                }
                            }
                        }
                    }
            ...
            prototype.validatePrintReady = function(ca, cr, results, elementType, index) {
                if (cr.isRequiresPrintReady() && !ca.isPrintReady() && !ca.isPhysicalContent()) {
            ...
            prototype.addAddOnToInstance = function(feature, productInstance) {
                var addOn = new ProductAddOn();
                var featureInstance = this.buildFeatureInstanceFromConfigured(feature);
                addOn.setFeature(featureInstance);
                productInstance.addAddOn(addOn);
                return addOn;
            };
            ...
            prototype.applyConfiguredPageExceptionToInstance = function(product, instance, applyDefaults) {
                ...
                var propertyIt = null;
                var peIt = null;
                var insertIt = instance.getInserts().iterator();
                var exceptionIt = instance.getExceptions().iterator();
                var addOnIt = instance.getAddOns().iterator();
                var property = null;
                var cfgPe = null;
                var pe = null;
                var insert = null;
                var productException = null;
                var addOn = null;
                ...
                while (cfgPeIt.hasNext()){
                    ...
                    propertyIt = cfgPe.getProperties().iterator();
                    while (propertyIt.hasNext()){
                        property = propertyIt.next();
                        if (Utils.isStringsEqual(property.getName(), "EXCEPTION_TYPE")) {
                            if (Utils.isStringsEqual(property.getValue(), "PRINTING_EXCEPTION")) {
                                if (!cfgPe.isSelectable()) {
                                    instance.getExceptions().clear();
                                } else {
                                    while (exceptionIt.hasNext()){
                                        productException = exceptionIt.next();
                                        this.applyConfiguredToFeatures(cfgPe.getFeatures(), productException, applyDefaults, false);
                                    }
                                }
                            } else if (Utils.isStringsEqual(property.getValue(), "INSERT")) {
                                if (!cfgPe.isSelectable()) {
                                    instance.getInserts().clear();
                                } else {
                                    while (insertIt.hasNext()){
                                        insert = insertIt.next();
                                        this.applyConfiguredToFeatures(cfgPe.getFeatures(), insert, applyDefaults, false);
                                    }
                                }
                            } else if (Utils.isStringsEqual(property.getValue(), "TAB")) {
                                if (!cfgPe.isSelectable()) {
                                    instance.getAddOns().clear();
                                } else {
                                    while (addOnIt.hasNext()){
                                        addOn = addOnIt.next();
                                        var cfgFeature = Utils.getElementById(addOn.getFeature().getId(), cfgPe.getFeatures());
                                        if (cfgFeature != null) {
                                            var cfgChoice = Utils.getElementById(addOn.getFeature().getChoice().getId(), cfgFeature.getChoices());
                                            if (cfgChoice != null) {
                                                this.applyConfiguredToProperties(cfgChoice.getProperties(), addOn.getFeature().getChoice().getProperties());
                                            }
                                        }
                                    }
                                }
            ...
            prototype.buildContentAssociationForCr = function(contentHint, purposeCrMap, pi, caList) {
                ...
                if (cr != null) {
                    ...
                    availablePageCount = this.getTotalPageCount(contentHint, pi);
            ...
            prototype.getTotalPageCount = function(contentHint, productInstance) {
            ...
            prototype.generateProductSummary = function(instance) {
                ...
                while (conAssociations.hasNext()){
                    ...
                    if (eachConAssociation != null) {
                        ...
                        while (pgGrps.hasNext()){
                            ...
                            if (instance.getExceptions() != null && instance.getExceptions().size() > 0) {
                                var exceptions = instance.getExceptions().iterator();
                                while (exceptions.hasNext()){
                                    var eachExcp = exceptions.next();
                                    var ranges = eachExcp.getRanges().iterator();
                                    while (ranges.hasNext()){
                                        var range = ranges.next();
                                        if (range != null) {
                                            var exceptionEnd = range.getEnd();
                                            if (Utils.isStringsEqual(pgGrpEnd + "", exceptionEnd + "")) {
                                                prdInstDt = new ProductInstanceDetails();
                                                fcMap = new ArrayMap();
                                                fcMap = this.buildFeatureChoiceMap(eachExcp.getFeatures());
                                                var fit = instance.getFeatures().iterator();
                                                while (fit.hasNext()){
                                                    var feature = fit.next();
                                                    if (feature.getName() != null) {
                                                        var ci = feature.getChoice();
                                                        if (ci != null) {
                                                            if (fcMap.get(feature.getName()) == null) {
                                                                fcMap.put(feature.getName(), ci.getName());
                                                            }
                                                        }
                                                    }
                                                }
                                                prdInstDt.setFileName(eachConAssociation.getFileName());
                                                prdInstDt.setFeatureChoiceMap(fcMap);
                                                prdInstDt.setType(ElementType.EXCEPTION);
                ...
                if (instance.getAddOns() != null && instance.getAddOns().size() > 0) {
                    prdInstDt = new ProductInstanceDetails();
                    var fi = null;
                    var ci = null;
                    fcMap = new ArrayMap();
                    var addOnIt = instance.getAddOns().iterator();
                    while (addOnIt.hasNext()){
                        var productAddOn = addOnIt.next();
                        if (productAddOn != null) {
                            fi = productAddOn.getFeature();
                            if (fi != null && fi.getName() != null) {
                                ci = fi.getChoice();
                                fcMap.put(fi.getName(), ci.getName());
                            }
                        }
                    }
                    prdInstDt.setFeatureChoiceMap(fcMap);
                    prdInstDt.setType(ElementType.ADDON);
                    detailsList.add(prdInstDt);
                }
                if (instance.getInserts() != null && instance.getInserts().size() > 0) {
                    prdInstDt = new ProductInstanceDetails();
                    var insertIt = instance.getInserts().iterator();
                    while (insertIt.hasNext()){
                        var insert = insertIt.next();
                        prdInstDt.setFeatureChoiceMap(this.buildFeatureChoiceMap(insert.getFeatures()));
                    }
                    prdInstDt.setFileName(null);
                    prdInstDt.setType(ElementType.INSERT);
                    detailsList.add(prdInstDt);
                }
            ...
            prototype.getFlattenedProduct = function(productInstance, configuredProduct) {
                ...
                insertIt = productInstance.getInserts().iterator();
                while (insertIt.hasNext()){
                    flattenedPageException = new FlattenedPageException();
                    insert = insertIt.next();
                    flattenedPageException.setHasContent(false);
                    flattenedPageException.setRanges(this.buildPageRange(insert.getPageNumber()));
                    propertiesMap = this.buildPropertyMapFromFeature(insert.getFeatures());
                    propertiesMap.put("EXCEPTION_TYPE", "INSERT");
                    flattenedPageException.setProperties(propertiesMap);
                    flattenedPageExceptionList.add(flattenedPageException);
                }
                exceptionIt = productInstance.getExceptions().iterator();
                while (exceptionIt.hasNext()){
                    flattenedPageException = new FlattenedPageException();
                    exception = exceptionIt.next();
                    flattenedPageException.setHasContent(false);
                    flattenedPageException.setRanges(exception.getRanges());
                    propertiesMap = this.buildPropertyMapFromFeature(exception.getFeatures());
                    propertiesMap.put("EXCEPTION_TYPE", "PRINTING_EXCEPTION");
                    flattenedPageException.setProperties(propertiesMap);
                    flattenedPageExceptionList.add(flattenedPageException);
                }
                addOnIt = productInstance.getAddOns().iterator();
                while (addOnIt.hasNext()){
                    addOn = addOnIt.next();
                    propertiesMap = new ArrayMap();
                    flattenedPageException = new FlattenedPageException();
                    flattenedPageException.setHasContent(false);
                    flattenedPageException.setRanges(this.buildPageRange(addOn.getPageNumber()));
                    var ci = addOn.getFeature().getChoice();
                    if (ci != null) {
                        var pit = ci.getProperties().iterator();
                        while (pit.hasNext()){
                            var pi = pit.next();
                            propertiesMap.put(pi.getName(), pi.getValue());
                        }
                    }
                    propertiesMap.put("EXCEPTION_TYPE", "TAB");
                    flattenedPageException.setProperties(propertiesMap);
                    flattenedPageExceptionList.add(flattenedPageException);
                }
            ...
            prototype.getConfiguredPageException = function(pe, productRules, context, cfgFeatures) {
                ...
                while (frIt.hasNext()){
                    ...
                    cf.setContentReqRefIds(cfgFeature.getContentReqRefIds());
            ...
            prototype.convertPageExceptionsToLegacyModel = function(pi) {
                var processor = new PageExceptionProcessor();
                processor.convertPageExceptionsToLegacyModel(pi);
            };
            prototype.convertLegacyModelToPageException = function(pi, cfgPageException) {
                var processor = new PageExceptionProcessor();
                processor.convertLegacyModelToPageException(pi, cfgPageException);
            };
        ...
        exports.ProductRelationType = ProductRelationType;
        ...
        exports.ProductAddOn = ProductAddOn;
        ...
        exports.PageExceptionProcessor = PageExceptionProcessor;
