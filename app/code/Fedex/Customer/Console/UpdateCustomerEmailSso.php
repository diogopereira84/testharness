 ...
 */
class UpdateCustomerEmailSso extends Command
{
    /**
    ...
    {
        $this->setName('fedex:customer:fix-company-admin-email-sso')
            ->setDescription('Update Sso company admin customer email to secondary email and external ID to email.')
            ->addOption(
                'limit',
                null,
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $companyCollection = $this->companyFactory->create()->getCollection()
                    ...
                    ->addFieldToFilter('storefront_login_method_option', 'commercial_store_sso');
        ...
        $companyCollection->getSelect()->where('customer.email != customer.external_id');
