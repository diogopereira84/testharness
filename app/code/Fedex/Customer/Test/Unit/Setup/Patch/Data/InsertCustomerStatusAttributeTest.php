...
namespace Fedex\Customer\Test\Unit\Setup\Patch\Data;

use Magento\Framework\Setup\ModuleDataSetupInterface;
use Magento\Customer\Setup\CustomerSetupFactory;
use Magento\Framework\TestFramework\Unit\Helper\ObjectManager;
use PHPUnit\Framework\TestCase;
use Fedex\Customer\Setup\Patch\Data\InsertCustomerStatusAttribute;
 ...
 */
class InsertCustomerStatusAttributeTest extends TestCase
{
    ...
    protected $insertCustomerStatusAttribute;
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->insertCustomerStatusAttribute = $this->objectManager->getObject(
            InsertCustomerStatusAttribute::class,
            [
    ...
    public function testApply()
    {
        ...
        $this->assertEquals(null, $this->insertCustomerStatusAttribute->apply());
    }
    ...
    {
        $this->assertEquals([], $this->insertCustomerStatusAttribute->getDependencies());
    }
    ...
    {
        $this->assertEquals([], $this->insertCustomerStatusAttribute->getAliases());
    }
}
