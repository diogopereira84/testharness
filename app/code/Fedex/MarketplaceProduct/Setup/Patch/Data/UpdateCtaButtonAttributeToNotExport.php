...
class UpdateCtaButtonAttributeToNotExport implements DataPatchInterface
{
    ...
    public function apply(): void
    {
        ...
        try {
            $attrProduct = $this->eavAttribute->getIdByCode(Product::ENTITY, self::CTA_VALUE_ATTRIBUTE);
