...
use Exception;
use Fedex\MarketplaceProduct\Setup\Patch\Data\CreateMapSkuCategoryAttribute;
...
class CreateMapSkuCategoryAttributeTest extends TestCase
{
    /**
     * @var CreateMapSkuCategoryAttribute
     */
    private CreateMapSkuCategoryAttribute $instance;
    ...
    protected function setUp(): void
    {
        ...
        $this->instance = new CreateMapSkuCategoryAttribute(
    ...
    public function testApplyWithException(): void
    {
        ...
        $this->eavSetupMock->expects(static::once())
            ...
            ->with(
                Category::ENTITY,
                CreateMapSkuCategoryAttribute::MAP_SKU_ATTRIBUTE_CODE,
                [
