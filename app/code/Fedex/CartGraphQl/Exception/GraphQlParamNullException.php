...
class GraphQlParamNullException extends LocalizedException implements AggregateExceptionInterface, ClientAware
{
    public const EXCEPTION_CATEGORY = 'graphql-param-null';
