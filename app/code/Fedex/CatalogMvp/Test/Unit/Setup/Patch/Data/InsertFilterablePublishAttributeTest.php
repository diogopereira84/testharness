...
use Fedex\CatalogMvp\Setup\Patch\Data\InsertFilterablePublishAttribute;

/**
 * Test class for InsertPublishedProductAttribute
 */

class InsertFilterablePublishAttributeTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->insertPublishedProductAttributeDataPatch = $this->getMockForAbstractClass(
            InsertFilterablePublishAttribute::class,
            [
