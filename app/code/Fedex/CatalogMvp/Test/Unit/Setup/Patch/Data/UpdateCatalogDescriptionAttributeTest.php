...
use Fedex\CatalogMvp\Setup\Patch\Data\UpdateCatalogDescriptionAttribute;
...
class UpdateCatalogDescriptionAttributeTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->updateUpdatedAtAttributeMock = $objectManagerHelper->getObject(
            UpdateCatalogDescriptionAttribute::class,
            [
