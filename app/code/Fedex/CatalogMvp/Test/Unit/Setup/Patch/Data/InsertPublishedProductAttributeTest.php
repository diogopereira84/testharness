...
use Fedex\CatalogMvp\Setup\Patch\Data\InsertPublishedProductAttribute;

/**
 * Test class for InsertPublishedProductAttribute
 */

class InsertPublishedProductAttributeTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->insertPublishedProductAttributeDataPatch = $this->getMockForAbstractClass(
            InsertPublishedProductAttribute::class,
            [
