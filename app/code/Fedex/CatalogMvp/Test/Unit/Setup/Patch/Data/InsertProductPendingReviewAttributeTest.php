...
use Fedex\CatalogMvp\Setup\Patch\Data\InsertProductPendingReviewAttribute;

class InsertProductPendingReviewAttributeTest extends TestCase
{
    ...
    */
    public function setUp(): void
    {
        ...
        $this->pendingReviewAttributeMock = $this->getMockForAbstractClass(
            InsertProductPendingReviewAttribute::class,
            [
