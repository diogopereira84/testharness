    ...
    $.widget('mage.productListToolbarForm', {
        ...
        changeUrl: function (paramName, paramValue, defaultValue) {
            ...
            if (this.options.post) {
                ...
                let tech_titans_d_208734_enabled = window?.checkout?.tech_titans_d_208734;
                
                if (tech_titans_d_208734_enabled)
                {
                    if (paramValue == defaultValue && paramName !== this.options.limit) {
